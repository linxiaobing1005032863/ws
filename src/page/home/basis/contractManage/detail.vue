<template>
  <div>
    <transition>
      <div class="page-add">
        <my-direct></my-direct>
        <el-form v-if="type === 'add' || detail" :model="form" ref="form" label-width="140px" class="demo-form">
          <div class="tit">基本信息</div>
          <el-row>
            <el-col :span="8">
              <el-form-item label="合同编号" required>
                <span v-if="disabled">{{detail.contractNum}}</span>
                <el-input v-else v-model="form.contractNum" size="small"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-form-item label="客户名称" required>
            ...
            <el-button type="text" v-if="!disabled" size="small" @click="handleAdd('addCus')">添加</el-button>
          </el-form-item>
          <el-form-item label="项目名称" required>
            ...
            <el-button v-if="!disabled" type="text" size="small" @click="handleAdd('addProject')">添加</el-button>
          </el-form-item>
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item class="flex" label="保养周期" required>
                ...
                <el-input v-else v-model="form.intervalTime" :disabled="disabled" size="small">
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="电梯台数" required>
                ...
                <el-input v-else v-model="form.elevatorsNum" size="small"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              <el-form-item label="维保负责人" required>
                ...
                <el-button type="text" v-if="type !== 'see'" size="small" @click="handleAdd('addEmployee')">添加</el-button>
              </el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="合同金额（元）" required>
                ...
                <el-input v-else v-model="form.amount" size="small"></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-form-item>
            <el-button v-if="disabled" type="primary" size="small" @click="type = 'edit'">编辑</el-button>
...
<script>
  ...
  import addCus from '../cusManage/detail';
  ...
  export default {
    components:{myDirect,addCus,addProject,addEmployee},
    data(){
      return {
        show: false,
        type: null,
