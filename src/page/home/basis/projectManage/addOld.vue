    ...
    <div v-if="show" class="page-add">
      ...
      <el-form :model="form" ref="form" label-width="120px" class="demo-form" >
        <el-row>
          ...
          <el-col :span="12" :inline="true">
	        ...
	        <el-form-item label="电梯数" >
				 <el-input v-model="form.elevatorNumber"  width="80px" placeholder="请输入电梯数" style="width:24%;"></el-input>  
			 </el-form-item>   
        ...
        <el-form-item label="详细地址" required :inline="true">
              <el-input v-model="form.detailAddress" :disabled="disabled" style="width:90%;" ></el-input>
         </el-form-item>
         <!-- 地圖 -->
        <div class="mapshow">
        ...
        <el-row>
        	<el-form-item label="客户名称" required>
	           <el-select v-model="form.cusmoterValue" placeholder="请选择区" requried>
	                  <el-option
	                    v-for="(item,indexs) in cusmoterList" :key='indexs'
	                     :label="item"
	                    :value="item">
	                  </el-option>
	             </el-select>
        ...
        <el-row>
        	<el-form-item label="关联合同" required>
	           <el-select v-model="form.contactUntilValue" placeholder="请选择区">
	                  <el-option
	                    v-for="(item,indexs) in contactUnitList" :key='indexs'
	                     :label="item"
	                    :value="item">
	                  </el-option>
	             </el-select>
...
import googMap from '@/components/map'
  export default {
    ...
    methods: {
	    ...
	    saveSubmit(){
	    	let sendData={
	    		"houseName":this.form.projectName,
	    		"province":this.form.addressValue,
	    		"city":this.form.cityValue,
	    		"area":this.form.areaValue,
	    		"address":this.form.detailAddress,
	    		"propId":"5ab4a3451b2d4f6b56c9f624",
